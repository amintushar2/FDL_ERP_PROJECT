    ...
    <div class="container-fluid col-lg-10 w-100 p-5">
            ...
            <div class="row p-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row p-1">
                        <label for="is_lefty" class="col-sm-4 col-form-label">Is Lefty :</label>
                            <div class="col-sm-7">
                ...
                <div class="row-md-6 m-3 text-center p-3">
                    <button class="btn btn-success" type="submit"id='offc_save'>Save</button>
                    <button class="btn btn-success" type="submit"id='offc_update'>Update</button> 
